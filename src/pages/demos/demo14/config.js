...
export const navSaveItem = {
  key: 'save',
  // icon: true,
  iconClass: 'lf-menu-save',
  title: 'Save',
  text: '保存',
  onMouseEnter: (lf, ev) => {
  ...
  onClick: (lf, ev) => {
    ...
    const xmlResult = lf.adapterOut(data);
    console.log('xml', xmlResult);
  },
};

export const navPlayItem = {
  key: 'play',
  // icon: true,
  iconClass: 'lf-menu-play',
  title: 'Play',
  text: '执行',
  onMouseEnter: (lf, ev) => {
    // const position = lf.getPointByClient(ev.x, ev.y)
...
export const getPatternItems = (lf) => {
  return [
    {
      label: '选区',
